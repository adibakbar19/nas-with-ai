"""Ingest job state persistence — PostgreSQL backed."""

# NOTE: claim_job() and requeue_stale_claims() are included
# for completeness but are worker-only operations.
# ingestion-api does not call these methods.
# They are used by nas-processor/src/worker/consumer.py only.
