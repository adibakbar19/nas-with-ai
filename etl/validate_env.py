...
from .env_check import validate_backend_env, validate_run_all_env
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--skip-load", default="0", help="run_all option")
    parser.add_argument("--skip-es", default="1", help="run_all option")
    ...
    if args.target in {"run_all", "all"}:
        missing.extend(
            validate_run_all_env(
                skip_load=_as_bool(args.skip_load),
                skip_es=_as_bool(args.skip_es),
